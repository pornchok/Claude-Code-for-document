...
แต่ยังพบได้จริงใน 3 สถานการณ์:
- **CI ที่ lock Docker image เป็นเวอร์ชันเก่า** — Chrome ใน image กับ ChromeDriver ไม่ match
- **องค์กรที่ block internet ใน CI** — webdrivermanager download driver ไม่ได้ ต้อง manage เอง
- **ทีมที่ยัง pin ChromeDriver แบบ manual** — ยังมีในองค์กรขนาดใหญ่ที่ process เปลี่ยนช้า
