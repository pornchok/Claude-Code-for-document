...
### 4.2 โครงสร้าง Page Object ใน TypeScript
...
### 4.3 Multi-Page Workflow — คืน Page Object แทน URL
...
### 4.5 Composition vs Inheritance
...
### 4.6 TypeScript Interface สำหรับ Page Objects
...
### 4.8 เปรียบเทียบกับ Robot Framework
...
**เวอร์ชันที่ถูกต้อง** คือ LoginPage ในตัวอย่าง Beginner ข้างต้น
